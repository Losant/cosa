...
const { curry, split, last, pipe } = require('omnibelt');
...
class Database extends EventEmitter {
  ...
  async find(collectionName, query, options) {
    ...
    if (options.count) {
      ...
      // broken until https://github.com/mongodb/node-mongodb-native/pull/1767 is merged and the npm package is republished.
